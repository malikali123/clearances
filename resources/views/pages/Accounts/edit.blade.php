        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('account.update', $account->id) }}" autocomplete="off">
                        @csrf
                        <div class="form-row">
...
{{--                            </div>--}}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" required value="{{$account->balance}}" name="palance" class="form-control">
                            </div>
