                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($data as $imports)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$imports->price}}</td>
                                                <td>{{$imports -> clearance ? $imports -> clearance -> name : 'بدون' }}</td>
...
{{--                                                    {{route('admin.maincategories.edit',$bank -> id)}}--}}
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        @if ($imports -> status > 0)
                                                            <a href="{{route('import.certificated', $imports -> id)}}"
                                                               class="btn btn-outline-success btn-min-width box-shadow-3 mr-1 mb-1"> طباعة شهادة الوارد</a>

                                                        @else

                                                        <a href="{{route('import.payment', $imports -> id)}}"
